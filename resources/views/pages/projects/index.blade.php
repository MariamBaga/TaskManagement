            ...
            <div class="modal-body">
                <form action="{{ route('projects.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="formFileMultipleone" class="form-label"> Icon</label>
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="exampleFormControlInput78"
                            value="{{ $project->nom }}" name="nom">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Catégorie de projet</label>
                        <select class="form-select @error('category') is-invalid @enderror"
                            aria-label="Default select Project Category" name="category">
                            <option value="UI/UX Design" {{ $project->category == 'UI/UX Design' ? 'selected' : '' }}>
                                UI/UX Design</option>
                            <option value="Website Design"
                            ...
                            <option value="Quality Assurance"
                                {{ $project->category == 'Quality Assurance' ? 'selected' : '' }}>Quality Assurance
                            </option>
                            <option value="Development" {{ $project->category == 'Development' ? 'selected' : '' }}>
                                Development</option>
                            <option value="Backend Development"
                            ...
                            <option value="Software Testing"
                                {{ $project->category == 'Software Testing' ? 'selected' : '' }}>Software Testing
                            </option>
                            <option value="Website Design"
                                {{ $project->category == 'Website Design' ? 'selected' : '' }}>
                                Website Design</option>
                            <option value="Marketing" {{ $project->category == 'Marketing' ? 'selected' : '' }}>
                                Marketing</option>
                            <option value="SEO" {{ $project->category == 'SEO' ? 'selected' : '' }}>SEO</option>
                            <option value="Other" {{ $project->category == 'Other' ? 'selected' : '' }}>Other
                            </option>
                        </select>
                    </div>
                    <div class="mb-3">
                        <label for="formFileMultiple456" class="form-label">Icon</label>
                        <select id="icon" class="form-select" name="icon">
                            <option value="" disabled selected>...</option>
                            <option value="fas fa-align-left">fas fa-align-left</option>
                            <option value="fas fa-align-right">fas fa-align-right</option>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col">
                                ...
                                <input type="date" class="form-control" id="datepickerded123"
                                    value="{{ $project->date_debut->format('Y-m-d') }}" name="start_at">
                            </div>
                            <div class="col">
                                ...
                                <input type="date" class="form-control" id="datepickerded456"
                                    value="{{ $project->date_fin->format('Y-m-d') }}" name="end_at">
                            </div>
                        </div>
                        <div class="row g-3 mb-3">
                            <div class="col-sm-12">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-sm">
                            ...
                            <select class="form-select @error('priority') is-invalid @enderror"
                                aria-label="Default select Priority" name="priority">
                                <option value="élevé" {{ $project->priority == 'élevé' ? 'selected' : '' }}>
                                    Supérieure</option>
                                <option value="Moyenne" {{ $project->priority == 'Moyenne' ? 'selected' : '' }}>
                                    Moyenne</option>
                                <option value="faible" {{ $project->priority == 'faible' ? 'selected' : '' }}>Faible
                                </option>
                                <option value="bas" {{ $project->priority == 'bas' ? 'selected' : '' }}>Le plus
                                    bas</option>
                            </select>
                        </div>
                    </div>
