                    ...
                    <div class="card ">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="avatar lg rounded-1 no-thumbnail"
                                    style="background-color: #EEE4FE; color: #333;">
                                ...
                                <div class="flex-fill ms-4">
                                    ...
                                    <h5 class="mb-0 ">
                                        {{ auth()->user()->role == 'admin' ? $tasks->count() : auth()->user()->tasks()->count() }}
                                    </h5>
                                </div>
                                <a href="{{ route('tasks.index') }}" title="voir-les-membres"
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-fill ms-4">
                                    ...
                                    <h5 class="mb-0 ">
                                        {{ auth()->user()->role == 'admin' ? $tasks->where('statut', 'complet')->count() : auth()->user()->tasks()->where('statut', 'complet')->count() }}
                                    </h5>
                                </div>
                                <a href="{{ route('tasks.index') }}" title="espace-utilisé"
                                    class="btn btn-link text-decoration-none  rounded-1"><i
                                        class="icofont-hand-drawn-right fs-2 "></i></a>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-fill ms-4">
                                    ...
                                    <h5 class="mb-0 ">
                                        {{ auth()->user()->role == 'admin' ? $tasks->where('statut', 'encours')->count() : auth()->user()->tasks()->where('statut', 'encours')->count() }}
                                    </h5>
                                </div>
                                <a href="{{ route('tasks.index') }}" title="date-de-renouvellement"
                                    class="btn btn-link text-decoration-none  rounded-1"><i
                                        class="icofont-hand-drawn-right fs-2 "></i></a>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    @foreach (auth()->user()->projects()->get() as $project)
                                        <tr>
                                            ...
                                            <td><img src="{{ $project->users->first()->image }}" alt="Avatar"
                                                    class="avatar sm  rounded-circle me-2"><a
                                                    href="#">{{ $project->users->first()->name }}</a></td>
                                            <td>
                                                <div class="progress">
                                                    <div class="progress-bar bg-primary" role="progressbar"
                                                        ...
                                                        @if ($project->statut == 'debut')
                                                            5%
                                                        @elseif($project->statut == 'encours')
                                                            50%
                                                        @else
                                                            100%
                                                        @endif
                                            ...
                                            <td><span
                                                    class="badge @if ($project->priority == 'élévé') bg-danger @elseif($project->priority == 'Moyenne') bg-warning @else bg-success @endif">{{ $project->priority }}</span>
                                            </td>
                                        </tr>
                                    @endforeach
